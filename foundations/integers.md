...
Целое число — цепочка битов фиксированной длины. Иногда нужно работать не с числом целиком, а с конкретным битом: проверить, установлен ли флаг, замаскировать часть адреса, объединить несколько флагов в одно число. Для этого существуют [побитовые операции](bitwise-operations.md).
