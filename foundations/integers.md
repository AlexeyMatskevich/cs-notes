...
Переполнение — причина реальных инцидентов. 4 июня 1996 года первый запуск ракеты Ariane 5 закончился взрывом через ~37 секунд после старта. В инерциальной навигационной системе шла конверсия 64-битного числа с плавающей точкой в 16-битное знаковое целое; значением была внутренняя величина BH (Horizontal Bias), связанная с горизонтальной скоростью. Для Ariane 4 эта величина всегда укладывалась в 16 бит; у Ariane 5 траектория давала большие значения, конверсия выдала Operand Error, навигационная программа упала, и ракета ушла с курса.
