...
Целая часть переводится так же, как в [двоичной системе](00-binary-and-bytes.md): 3 = 2 + 1 = 11₂.
...
Показатель степени может быть отрицательным: число 0.15625 = 1.01 × 2⁻³, здесь экспонента = −3. Как хранить отрицательную экспоненту?
