...
У этих правил есть продолжение: что происходит при делении на ноль, как ведёт себя квадратный корень из отрицательного числа, почему сумма миллиона одинаковых чисел не равна их произведению на количество — и как защищаться от накопления ошибок. Этим занимается [следующая заметка](floating-point-edge-cases.md).
