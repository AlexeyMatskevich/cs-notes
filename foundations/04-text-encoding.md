...
<- [Числа с плавающей точкой](03-floating-point.md) | [Порядок байтов](05-endianness.md) ->
...
Числа, текст — всё записывается как последовательность байтов. Когда значение занимает больше одного байта, возникает неочевидный вопрос: в каком порядке байты хранить в памяти? Число `0x0429` — это `04 29` или `29 04`? Ответ — в [следующей заметке](05-endianness.md).
