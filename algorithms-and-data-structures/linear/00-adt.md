...
**Предпосылки:** [базовое программирование](../../programming/index.md) (переменные, типы, условия, циклы, функции), оценка сложности в O(…).
...
Первое требование, которое можно сформулировать на языке ADT: положить n значений и достать любое по номеру за O(1). Этот контракт — ADT Array, и [массив](01-array.md) — его простейшая реализация.
