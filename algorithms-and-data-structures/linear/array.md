...
Процессор читает память [[computer/data-path/memory-hierarchy#кеш-линия-минимальная-единица-обмена|кэш-линиями]] — блоками фиксированного размера (часто 64 байта; зависит от CPU). Когда читаешь один байт, загружается вся линия вокруг него.
