...
Односвязный список добавляет минимум один указатель на узел — обычно 8 байт на 64-bit, плюс возможный padding из-за [выравнивания](../../computer/06-abi-and-data-layout.md). Двусвязный — два указателя, обычно 16 байт.
