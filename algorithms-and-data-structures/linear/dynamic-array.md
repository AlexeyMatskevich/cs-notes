...
**Предпосылки:** [массив](array.md) (формула адреса, непрерывность, O(1) доступ по индексу, фиксированный размер; цена вставки и удаления — сдвиг элементов, асимметрия «конец дешёвый, начало дорогое»); оценка сложности O(…).

<- [Массив](array.md) | [Связный список](linked-list.md) ->
