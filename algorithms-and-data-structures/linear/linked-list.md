...
**Предпосылки:** [[algorithms-and-data-structures/linear/array|массив]] (непрерывность, кэш-локальность), [динамический массив](dynamic-array.md) (проблема O(n) вставки), [указатели и ссылки, куча, освобождение памяти](../../programming/memory.md), оценка сложности O(…), базовое чтение Ruby (классы, методы, переменные экземпляра, `nil`).
