...
PostgreSQL использует [clock-sweep](clock-sweep.md) для [shared buffers](../../databases/postgresql/durability/buffer-cache.md#алгоритм-вытеснения) — кэша страниц диска в разделяемой памяти, где тысячи backend-процессов конкурируют за доступ. Операционные системы применяют аналогичный алгоритм (CLOCK) для [page replacement](../../linux/foundations/virtual-memory.md) — вытеснения страниц виртуальной памяти на диск.
