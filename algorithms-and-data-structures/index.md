...
**Предпосылки:** [базовое программирование](../programming/index.md) (переменные, типы, условия, циклы, функции, [указатели/ссылки](../programming/07-memory.md)) и оценка сложности в O(…).
