...
**B* дерево** поднимает нижнюю границу заполнения узла с 1/2 до **2/3**: вместо «не меньше половины» — «не меньше двух третей». Звёздочка (*) обозначает вариант [[algorithms-and-data-structures/non-linear/b-tree|B-дерева]] с более плотной упаковкой узлов.
...
| Характеристика | [[algorithms-and-data-structures/non-linear/b-tree\|B-дерево]] | [B+ дерево](b-plus-tree.md) | B* дерево |
|----------------|----------|-----------|-----------|
