...
Граф — общая структура, но для многих задач нужна более строгая форма. Если из связного графа убрать все «лишние» рёбра так, чтобы между любыми двумя вершинами остался ровно один путь — получится [дерево](tree.md).
