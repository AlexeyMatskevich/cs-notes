...
[Граф](graph.md) — общая структура, но для многих задач нужна более строгая форма. Если из связного [графа](graph.md) убрать все «лишние» рёбра так, чтобы между любыми двумя вершинами остался ровно один путь — получится [дерево](tree.md).
