...
**Завершённое (complete) бинарное дерево** — все уровни заполнены, кроме, возможно, последнего, который заполняется строго слева направо. Завершённое дерево из n узлов имеет высоту ⌊log₂(n)⌋, и его можно компактно хранить в массиве без указателей — это свойство использует [куча](heap.md).
