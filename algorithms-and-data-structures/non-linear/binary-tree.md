...
**Pre-order: записать и восстановить.** Чтобы сохранить дерево в файл или передать его по сети, структуру надо превратить в плоский линейный список значений. Запишем узлы в порядке «сначала сам узел, потом всё левое поддерево, потом всё правое». При обратном чтении это однозначно восстанавливает дерево: первое значение в списке — всегда корень; за ним идёт целиком левое поддерево, потом целиком правое, и каждое поддерево читается тем же правилом — то есть рекурсивно. Без фиксированного порядка «корень раньше детей» по плоскому списку нельзя было бы понять, кто чей родитель.
