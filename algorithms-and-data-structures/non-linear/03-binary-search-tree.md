...
Даже сбалансированное BST хранит один ключ в узле. В оперативной памяти это не проблема, но на диске каждый узел — отдельное чтение. При миллионе ключей поиск требует ~20 обращений к диску. [B-дерево](05-b-tree.md) решает эту проблему: один узел занимает целую страницу диска и хранит сотни ключей, снижая количество чтений до 3–4.
