...
**Предпосылки:** оценка сложности в O(…), [бинарное дерево](02-binary-tree.md) (left/right, обходы — особенно in-order).
