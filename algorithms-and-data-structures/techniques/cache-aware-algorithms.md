...
**Предпосылки:** [массив](../linear/array.md) (непрерывный блок памяти, формула адреса); [[computer/data-path/memory-hierarchy|иерархия памяти и кеш]] (кеш-линия, локальность, три типа промахов, latency vs bandwidth).
...
Разница — 4–5 раз, и почти вся она объясняется тем, что B-tree упаковывает работу в несколько [[computer/data-path/memory-hierarchy#Кеш-линия: минимальная единица обмена|кеш-линий]] на узел вместо одной линии на один ключ. То же самое происходит и на диске: узел B-tree обычно совпадает по размеру со страницей (4–16 КБ), и одно обращение к диску приносит все ключи узла сразу.
