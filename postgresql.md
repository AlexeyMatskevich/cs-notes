...
PostgreSQL использует MVCC-структуры (xmin/xmax, CLOG, snapshot) для реализации каждого уровня изоляции. Для каждого уровня: Ruby-код → SQL → что происходит внутри.
