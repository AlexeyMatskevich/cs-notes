...
**Предпосылки:** [бит, байт, hex](../../foundations/binary-and-bytes.md), [виртуальная память](../foundations/virtual-memory/virtual-memory.md) (mmap, [[linux/foundations/virtual-memory/page-faults#Demand paging: ленивая загрузка|demand paging]], [[linux/foundations/virtual-memory/page-faults#Copy-on-write: fork() без копирования|copy-on-write]]), [[linux/foundations/processes#exec(): замена программы|процессы]] (exec, fork+exec), базовое чтение кода на C (функции, указатели, указатели на функции).
