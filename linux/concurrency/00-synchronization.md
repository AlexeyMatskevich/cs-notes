...
[планировщик](../foundations/07-scheduler.md) (вытеснение между любыми двумя инструкциями), [потоки](../foundations/03-threads.md) (общее адресное пространство, CLONE_VM), [когерентность кешей](../../computer/data-path/01-cache-coherency.md) (MESI, invalidate, cache line ping-pong).
