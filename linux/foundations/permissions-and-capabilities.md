...
[Контейнеры](../containers/containers.md#capabilities-дробление-root-привилегий) активно используют capabilities для ограничения привилегий -- Docker по умолчанию даёт контейнеру лишь часть из ~40 capabilities, остальные сбрасывает.
