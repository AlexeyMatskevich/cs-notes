...
Программе нужны файлы с именами, правами и путями. Диск ничего об этом не знает. С точки зрения ядра, [диск](../../computer/data-path/storage.md#hdd-механика-вращающихся-пластин) -- массив блоков фиксированного размера. HDD отдаёт секторы по 512 байт или 4 КБ; SSD -- страницы по 4-16 КБ. Ядро Linux работает с блоками (blocks) -- логическими единицами, обычно по 4 КБ, выровненными с размером страницы виртуальной памяти.
