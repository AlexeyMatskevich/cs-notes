...
Теперь понятно, из чего сделан процесс. Остался вопрос: как такая структура возникает?
...
Мы создали процесс и загрузили программу. Но что происходит с процессом между запуском и завершением — пока он ждёт данных с диска, обрабатывает запрос, получает сигнал? Ядро постоянно отслеживает это.
...
Теперь, когда все части — fork, exec, состояния, зомби, сироты, дерево — лежат перед нами, можно проследить, как они складываются в жизнь одного процесса.
