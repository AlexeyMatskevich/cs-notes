...
**Таблица [файловых дескрипторов](file-descriptors.md)** — массив указателей на открытые файлы, [сокеты](../programming/sockets.md), пайпы. Дескриптор 0 — stdin, 1 — stdout, 2 — stderr. Лимит по умолчанию — 1024 дескриптора на процесс (`ulimit -n`), можно поднять до сотен тысяч.
