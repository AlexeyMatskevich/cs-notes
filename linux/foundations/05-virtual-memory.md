...
> [!info]- Предпосылки
> [файловые дескрипторы](04-file-descriptors.md) (fd, inode), [процессы](02-processes.md) (fork, copy-on-write на уровне эффекта), [иерархия памяти](../../computer/data-path/00-memory-hierarchy.md) (cache line, TLB), [когерентность кешей](../../computer/data-path/01-cache-coherency.md) (MESI).
