...
Каждый процесс в Linux имеет владельца. В [заметке о процессах](02-processes.md) мы видели, что `task_struct` хранит UID и GID. На самом деле идентичность процесса устроена сложнее -- у него не одна пара UID/GID (User ID / Group ID), а несколько.
