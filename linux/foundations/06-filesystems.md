...
[виртуальная память](05-virtual-memory.md) (страницы, page fault, demand paging), [хранилище](../../computer/04-storage.md) (HDD seek/rotation, SSD IOPS, NAND write asymmetry), [файловые дескрипторы](04-file-descriptors.md) (fd, inode).
