...
Сильная сторона исключений в том, что обработчик не обязан стоять прямо рядом с местом сбоя. Ошибка может подняться по цепочке вызовов — тем самым кадрам стека из [заметки о памяти](07-memory.md):
