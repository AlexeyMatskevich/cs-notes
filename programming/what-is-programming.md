...
Следующий шаг — понять, как программист общается с процессором напрямую: в [Ассемблере](assembler.md).
