...
**Целые числа (integer)** — числа без дробной части: количество сотрудников, номер заказа, год.
...
**Дробные числа (float)** — числа с точкой: налоговая ставка, температура, координаты.
