...
В [предыдущей заметке](what-is-programming.md) мы описали компьютер тремя частями: процессор, память, ввод/вывод. Для ассемблера нужны две детали, которые мы тогда опустили.
