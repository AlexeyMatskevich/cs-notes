...
**Предпосылки:** [Циклы](04-loops.md) (while), [Функции](05-functions.md) (определение, вызов, параметры, возврат значения).
...
Когда места не хватает, массив расширяется. Как именно он растёт внутри, разбирается в [динамическом массиве](../algorithms-and-data-structures/linear/02-dynamic-array.md). Обратите внимание: присваивание `order_totals[100] = 0` также может создать «дырки». Здесь мы используем `<<`, чтобы показать обычный путь добавления в конец.
