...
На протяжении всего курса мы писали код вроде `salary = 1500`. Процессор таких слов не понимает. Ему нужны инструкции низкого уровня в [ассемблере](assembler.md). Значит, между исходным кодом и выполнением всегда есть этап перевода.
