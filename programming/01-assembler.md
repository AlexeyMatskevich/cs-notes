...
Одна ячейка хранит число от 0 до 255 — ровно 256 разных значений. Четыре ячейки вместе дают 256 × 256 × 256 × 256 ≈ 4 миллиарда вариантов — этого хватает для большинства обычных чисел. Поэтому если первое число лежит по адресу 200, следующее начинается не с 201, а с 204 — через 4 ячейки.
