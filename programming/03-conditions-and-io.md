...
**Предпосылки:** [Переменные и типы](02-variables-and-types.md) (переменные, присваивание, примитивные типы).

<- [Переменные и типы](02-variables-and-types.md) | [Циклы](04-loops.md) ->
...
**Вывод** — показать результат человеку. В Ruby для этого используют `puts`:
...
**Ввод** — прочитать данные от пользователя. В Ruby для этого используют `gets`:
...
Здесь `active\n` означает: пользователь ввёл `active` и нажал Enter.
