...
## F. Намеренные forward-ссылки (не дефекты — не «чинить» переупорядочиванием)

Курсовой codex-разбор последовательности отметил их как кандидатов на проблему порядка; на деле они вынуждены зависимостями и корректно оформлены inline-глоссой + forward-ссылкой (§2 «побочные упоминания»). Переупорядочивание сломало бы более раннюю зависимость, поэтому это осознанный приём, а не дыра.
