...
Все агрегатные функции **игнорируют NULL** (кроме `COUNT(*)`): [NULL означает «значение неизвестно»](../foundations/types-and-null.md#null--отсутствие-значения), и включать неизвестное в сумму бессмысленно. SUM сложил 90000+60000+85000+70000+55000 = 360000. AVG (от average, «среднее») поделил на 5, не на 6 — Дина пропущена. Это важно: если бы AVG делил на 6, средняя была бы 60000 вместо 72000.
...
AVG для `department_id=1` = (90000 + 85000) / 2 = 87500. Дина (NULL) игнорируется — делим на 2, не на 3. NULL-значения `department_id` образуют **одну группу**, [аналогично DISTINCT](../foundations/types-and-null.md#null-в-разных-контекстах).
