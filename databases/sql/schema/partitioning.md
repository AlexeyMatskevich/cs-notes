...
**HASH** — по хешу значения: строки равномерно распределяются по N частям. Используется, когда нет естественного ключа для RANGE или LIST, но нужно разделить нагрузку по I/O. Тот же принцип лежит в основе [шардинга](../../../system-design/sharding.md) — разделения данных между несколькими серверами.
