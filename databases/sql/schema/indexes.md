...
После массовых обновлений СУБД может обращаться к таблице для проверки видимости строк — Index Only Scan временно теряет преимущество. Подробности — в [B-tree](../../postgresql/indexes/btree.md#index-only-scan-обход-без-heap).
