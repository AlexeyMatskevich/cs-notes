...
PostgreSQL создаёт уникальный [B-tree индекс](../../postgresql/indexes/00-btree.md) для PRIMARY KEY. Почти каждая таблица должна иметь PRIMARY KEY.
...
UNIQUE запрещает дубликаты в столбце (или комбинации столбцов). PostgreSQL создаёт уникальный B-tree индекс.
...
6. Добавление ограничений на таблицу с данными и трафиком требует осторожности — [безопасные паттерны](../../migrations/00-safe-schema-changes.md).
