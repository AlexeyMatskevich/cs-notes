...
**Предпосылки:** [оконные функции](../querying/07-window-functions.md) (ROW_NUMBER, PARTITION BY).

← [Материализованные представления](07-materialized-views.md)
...
DISTINCT ON — PostgreSQL-shortcut для частного случая top-1. Для top-N или портативного SQL — ROW_NUMBER + CTE. Для top-N с использованием индекса — [LATERAL](../querying/05-subqueries-and-cte.md#lateral--подзапрос-с-доступом-к-внешним-строкам).
