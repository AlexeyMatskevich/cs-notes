...
**Предпосылки:** [представления](../schema/views.md) (CREATE VIEW), [индексы](../schema/indexes.md) ([UNIQUE INDEX](../schema/indexes.md)).

← [Партиционирование](partitioning.md) | [DISTINCT ON](distinct-on.md) →
...
В отличие от обычного [view](../schema/views.md), данные вычисляются один раз и хранятся физически. Запросы к materialized view быстрые — это обычное чтение таблицы. Но данные могут устареть.
