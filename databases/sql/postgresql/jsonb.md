...
> [!info]- Предпосылки
> [SELECT и фильтрация](../querying/select-and-filtering.md), [соединения](../querying/joins.md), [индексы](../schema/indexes.md) (CREATE INDEX, типы индексов).

← [PostgreSQL: расширения](pg-extensions.md) | [Массивы и диапазоны](arrays-and-ranges.md) →
...
Для эффективного поиска по JSONB — [GIN индекс](../../postgresql/indexes/gin.md):
