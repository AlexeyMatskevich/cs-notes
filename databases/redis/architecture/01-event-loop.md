...
Раз все команды выполняются в одном потоке, медленная команда задерживает всех остальных клиентов. Общий паттерн проблемных команд — одна команда, которая за один вызов обходит большой объём данных. Практические примеры на Rails — в [заметке о блокирующих командах](../../../rails/redis/03-blocking-pitfalls.md).
