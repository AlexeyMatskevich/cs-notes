...
**Предпосылки:** [репликация](../../../system-design/replication.md) и [шардинг](../../../system-design/sharding.md) (failover, кворум, shard key), [Event loop](../architecture/01-event-loop.md), сеть (клиент/сервер), базовое понимание ключей и команд.
