...
Отдельная граница Redis: репликация по умолчанию асинхронная. Это влияет на свежесть чтений с реплик и на риск потери последних подтверждённых записей при failover — детали и инструменты снижения риска описаны в [репликации](./replication.md).
