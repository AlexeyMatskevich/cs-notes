...
[Логические базы](../architecture/03-logical-databases.md) (`SELECT`, db 0..N) в Cluster не поддерживаются: всегда используется db 0, а команда `SELECT` запрещена. Данные разделяют префиксами в ключах или разными кластерами.
