...
Потеря данных при failover остаётся возможной — это следствие [асинхронной репликации](./replication.md#асинхронность-устаревшие-чтения-и-окно-потери): команды, не дошедшие до реплик до момента падения мастера, теряются при промоутировании. Масштаб потери ограничен окном асинхронности, но для критичных операций стоит использовать `WAIT` и/или настройки кворума реплик на запись.
