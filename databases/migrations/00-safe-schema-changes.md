...
5. Если сбой — не снимать write-freeze: сначала удалить [INVALID-индекс](../sql/postgresql/04-index-operations.md#сбой-при-concurrently--invalid-индекс) (`DROP INDEX CONCURRENTLY`), только потом разбираться с причиной и повторять build
