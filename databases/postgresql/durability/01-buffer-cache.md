...
На HDD одна случайная операция чтения страницы обычно занимает порядка ~10 мс (см. оценку в [страницах и кортежах](../storage/01-pages-and-tuples.md)). Поэтому даже небольшая доля cache miss начинает доминировать во времени запроса.
