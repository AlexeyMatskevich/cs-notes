...
**Предпосылки:** [SQL](../sql/index.md) (SELECT, INSERT, UPDATE, DELETE), [транзакции](../sql/modification/01-transactions.md) (BEGIN, COMMIT, ROLLBACK), [ACID](../acid.md).
...
- [ACID в PostgreSQL](storage/00-acid.md) — реализация [ACID](../acid.md) через MVCC, WAL, constraints
...
- [Физическая структура хранения](storage/03-physical-layout.md) — файлы, форки, сегменты на диске и связь с WAL
...
Практический DDL (CREATE TABLE, constraints, партиционирование) — в [SQL: определение структуры](../sql/schema/00-tables-and-types.md). PG-специфичные расширения (JSONB, массивы, полнотекстовый поиск, функции) — в [SQL: PostgreSQL](../sql/postgresql/00-jsonb.md).
