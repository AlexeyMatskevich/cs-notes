...
← [Подзапросы и CTE](subqueries-and-cte.md) | [Память и spill](memory-and-spill.md) →
...
Алгоритмы соединений описаны в [планировщике запросов](planner.md). При чтении плана полезно помнить простую связь:
