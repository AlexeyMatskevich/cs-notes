...
**Предпосылки:** [страницы и кортежи](../storage/01-pages-and-tuples.md), [B-tree](../indexes/00-btree.md) (типы сканирования: Index Scan, Bitmap Index Scan, Index Only Scan), [BRIN](../indexes/04-brin.md) (корреляция физического и логического порядка), [хеш-таблица](../../../algorithms-and-data-structures/linear/05-hash-table.md) (для понимания Hash Join).
