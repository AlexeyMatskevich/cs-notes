...
**[GIN](gin.md)** работает с составными значениями, но отвечает только на вопрос "содержит ли значение элемент X". Поиск по дискретному вхождению.
...
GiST — фреймворк для пространственных и нестандартных типов данных. Для простейшего случая — поиск только по точному равенству — существует более компактный [Hash-индекс](hash.md).
