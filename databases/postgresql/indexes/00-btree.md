...
Ограничение: Index Only Scan работает только если страница heap помечена как "all-visible" в **Visibility Map (VM)** — битовой карте, где каждый бит указывает, что все строки на соответствующей странице видимы всем транзакциям (подробнее — [VACUUM](../maintenance/00-vacuum.md) и [MVCC](../concurrency/00-mvcc.md)). Если страница недавно менялась и VM ещё не обновлена, PostgreSQL всё равно ходит в heap за проверкой видимости.
