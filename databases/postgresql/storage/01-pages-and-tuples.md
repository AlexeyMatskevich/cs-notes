...
**HDD (жёсткий диск, [подробнее](../../../computer/data-path/03-storage.md)):** вращающиеся пластины и механическая головка. Для случайного чтения/записи устройству нужно «дойти» до нужного места, поэтому задержка одной операции измеряется миллисекундами.
