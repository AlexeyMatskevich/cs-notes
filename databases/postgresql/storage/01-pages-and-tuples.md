...
**HDD (жёсткий диск):** вращающиеся пластины и механическая головка. Для случайного чтения/записи устройству нужно «дойти» до нужного места, поэтому задержка одной операции измеряется миллисекундами.
