...
Когда нужно разбираться с I/O, bloat или восстановлением после сбоя, быстро всплывает «файловая сторона» PostgreSQL: где лежит data directory, почему имя файла не равно имени таблицы, что такое forks и сегменты, где живут WAL и статусы транзакций. Ниже — базовые термины и соответствия, которые помогают уверенно ориентироваться на диске.
