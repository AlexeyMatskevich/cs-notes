...
← [Страницы и кортежи](pages-and-tuples.md) | [Физическая структура хранения](physical-layout.md) →
...
У TOAST-таблицы своя FSM (карта свободного места), своя VM (карта видимости). Фоновая очистка ([VACUUM](../maintenance/vacuum.md)) основной таблицы автоматически обрабатывает и TOAST-таблицу.
...
TOAST решает проблему хранения больших значений в рамках страничной организации. Полная картина физического хранения — от кластера до форков — описана в заметке о [физической структуре хранения](physical-layout.md).
