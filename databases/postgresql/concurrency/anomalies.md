...
[MVCC](mvcc.md) в PostgreSQL делает dirty read невозможным на любом уровне изоляции: незакоммиченные tuple имеют xmin активной транзакции и невидимы по правилам проверки видимости. Но даже если транзакция видит только закоммиченные данные, это не гарантирует согласованности внутри одной транзакции.
