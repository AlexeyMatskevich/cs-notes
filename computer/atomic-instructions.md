...
Если линия уже принадлежит текущему ядру (состояние Modified или Exclusive), атомарная инструкция добавляет лишь несколько тактов — порядка ~5-20 нс. Ядру не нужно обращаться к другим — данные локальны.
