...
**Предпосылки:** [[computer/programmer-model/isa|ISA]] (инструкции, x86 vs ARM), [[computer/data-path/cache-coherency|когерентность кешей]] (MESI, Modified, кеш-линия, invalidate, cache-to-cache transfer).
...
Таблица задержек, разбираемая в [[computer/data-path/cache-coherency#Цена когерентности в наносекундах|цене когерентности]], здесь работает как прейскурант атомарных операций:
