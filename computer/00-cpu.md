...
Реальные процессоры делят работу не на 3, а на 14–20+ стадий. Intel Haswell (2013) использует конвейер из 14 стадий, ранний Pentium 4 Willamette (2000) — из 20. Больше стадий — более мелкая работа на каждой, а значит можно поднять частоту (короткая стадия завершается быстрее, такт можно укоротить). Поздняя ревизия Pentium 4 — Prescott — удлинила конвейер до 31 стадии и достигла 3.8 ГГц, тогда как PowerPC G4 с конвейером из 7 стадий тех же лет упирался в 1.4 ГГц. Но у длинного конвейера есть обратная сторона.
