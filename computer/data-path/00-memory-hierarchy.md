...
При шаге больше 4096 байт (размер страницы) каждое обращение попадает на новую страницу, промахи TLB накладываются на промахи кеша, и пропускная способность падает ещё в 2–3 раза.
