...
Типичная конфигурация сервера баз данных: 2–4 NVMe SSD в RAID для активной базы, массив HDD для бэкапов и [WAL-архивов](../../databases/postgresql/durability/00-wal.md). Или в распределённых системах: горячий слой на SSD (последние 7 дней данных), тёплый/холодный слой на HDD (история за годы).
