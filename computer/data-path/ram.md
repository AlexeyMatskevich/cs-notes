...
Одна ячейка и refresh объясняют, почему DRAM медленнее SRAM. Но откуда берётся конкретное число в ~60 нс? Оно возникает из того, как миллиарды ячеек организованы и адресуются.
...
50-кратный разрыв понятен, но возникает вопрос: можно ли сделать DRAM быстрее при случайном доступе? Ведь каждая строка занята на ~40 нс, а другие запросы просто стоят в очереди.
