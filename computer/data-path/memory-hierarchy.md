...
Когда двум адресам приходится делить одну позицию, один вытесняет другой — это [конфликтный промах](#conflict-miss). Сколько линий помещается в одном наборе — определяет, насколько остра эта проблема. Это число называется **ассоциативностью** (associativity, буквально — степень группировки).
