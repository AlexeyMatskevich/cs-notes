...
На Linux x86-64 действует **System V AMD64 ABI**, описанный в документе ~130 страниц. Он охватывает не только вызовы функций, но и формат ELF-файлов (Executable and Linkable Format), способ передачи структур (маленькие структуры в регистрах, крупные — через копирование на стек), размещение thread-local storage и даже способ обработки исключений C++.
