...
**Предпосылки:** [ABI и размещение данных](01-abi-and-data-layout.md) (xmm-регистры, выравнивание), [кеш-линия](../data-path/00-memory-hierarchy.md) (64 байта — единица передачи между кешем и памятью).
