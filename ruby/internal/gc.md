...
← [String](collections/02-string.md) | [JIT-компиляция](jit.md) →
...
Куча в MRI разбита на **страницы** (`struct heap_page`) — это собственные страницы Ruby GC, не путать со [страницами виртуальной памяти ОС](../../linux/foundations/05-virtual-memory.md), хотя принцип похож: фиксированные блоки для управления памятью. Каждая страница содержит **слоты** (RVALUE-слоты) одинакового размера; один слот — место под один объект.
