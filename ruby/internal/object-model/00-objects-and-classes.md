...
- **Таблица методов** (`m_tbl`) — хеш: имя метода → определение (включая скомпилированный ISeq для Ruby-методов, о котором мы говорили в [заметке о компиляции](../vm/01-compilation.md)).
