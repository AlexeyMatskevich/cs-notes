...
- **Таблица методов** (`m_tbl`) — [хеш-таблица](../../../algorithms-and-data-structures/linear/05-hash-table.md): имя метода → определение (включая скомпилированный ISeq для Ruby-методов, о котором мы говорили в [заметке о компиляции](../vm/01-compilation.md)).
