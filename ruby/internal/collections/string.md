...
Буфер копируется только при модификации дочерней строки — Copy-on-Write. Механизм идентичен [shared-массивам](array.md): shared-корень pinned для GC compaction, копирование происходит только при записи.
