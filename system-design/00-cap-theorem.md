...
CP-система отказывает изолированному узлу в ответе. Но при partition оба узла теряют связь — каждый считает, что именно другой отвалился. Node1 думает «Node2 и Node3 пропали», а Node2 и Node3 думают «Node1 пропал». Кто прав — объективно неизвестно.
...
Кворум определяет, кто работает, а кто нет. Но CP-поведение проявляется и на уровне каждой отдельной записи: при синхронной репликации primary не подтверждает COMMIT, пока синхронная реплика не подтвердила получение WAL.
