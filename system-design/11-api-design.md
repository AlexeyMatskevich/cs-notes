...
**Предпосылки:** [Паттерны надёжности](06-reliability-patterns.md) (idempotency, retry, timeout), [Message Queues](09-message-queues.md) (асинхронная коммуникация), [Выбор хранилища](10-storage-selection.md) (паттерн доступа как критерий), [HTTP](../network.md) (методы, заголовки, статус-коды).
