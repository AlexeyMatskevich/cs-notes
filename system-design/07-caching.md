...
До сих пор мы рассматривали кэш как один слой. На практике уровни кэширования (CDN, локальный, внешний) часто используются одновременно. Это создаёт архитектуру, похожую на иерархию CPU-кэшей (L1/L2/L3), но с важным отличием: в CPU [когерентность реализована аппаратно](../computer/02-cache-coherency.md) (MESI protocol), в web-архитектуре — вручную.
