...
Consistent hashing минимизирует объём миграции: при добавлении узла перемещается только ~1/N данных вместо большинства. Подробнее этот механизм описан в контексте [распределённого кэша](07-caching.md).
