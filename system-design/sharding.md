...
Шардинг (от shard — «осколок») — разделение набора данных на части, каждая из которых живёт на своём узле. В отличие от [репликации](replication.md), где каждый узел хранит всё, при шардинге каждый узел хранит только свою часть.
...
На практике шардинг и [репликация](replication.md) не взаимоисключающие решения — это два слоя одной архитектуры. Шардинг решает ёмкость и запись, [репликация](replication.md) внутри каждого шарда — доступность и масштабирование чтения.
