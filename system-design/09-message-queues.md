...
- [Sidekiq: архитектура](../rails/sidekiq/00-architecture.md) — три роли, данные в Redis, устройство серверного процесса
- [Sidekiq: retry и обработка ошибок](../rails/sidekiq/03-retry-and-errors.md) — формула retry, sorted sets, Dead Letter Queue
