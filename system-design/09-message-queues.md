...
**Предпосылки:** [гарантии доставки](08-delivery-guarantees.md) (at-most-once, at-least-once, exactly-once = idempotency), [паттерны надёжности](06-reliability-patterns.md) (retry, cascading failure), [кэширование](07-caching.md) (Redis как внешний сервис).
