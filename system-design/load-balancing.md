...
HTTP-запрос проходит через [уровни сетевого стека](../networking/infrastructure/reference-models.md): IP → TCP → HTTP. LB может работать на разных уровнях, и это определяет его возможности.
