...
При использовании [кэша](caching.md) read-your-writes нарушается, если между записью и чтением данные отдаются из устаревшего кэша. [[system-design/caching#консистентность-и-кэш|Стратегии восстановления]]: инвалидация при записи, write-through, обход кэша для автора.
