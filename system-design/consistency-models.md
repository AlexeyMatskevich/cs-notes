...
При использовании [кэша](caching.md) read-your-writes нарушается, если между записью и чтением данные отдаются из устаревшего кэша. [Стратегии восстановления](caching.md#консистентность-и-кэш): инвалидация при записи, write-through, обход кэша для автора.
