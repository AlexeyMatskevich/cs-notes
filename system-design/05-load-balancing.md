...
**Предпосылки:** клиент-серверная архитектура, DNS (домен → IP), TCP/HTTP ([network.md](../network.md)), горизонтальное масштабирование (несколько одинаковых серверов), понятие отказа узла.
