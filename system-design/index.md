...
**Предпосылки:** базовое понимание клиент-серверной архитектуры, сетевых протоколов ([networking](../networking/index.md)), структур данных ([algorithms-and-data-structures/index.md](../algorithms-and-data-structures/index.md)), баз данных ([databases/](../databases/)).
