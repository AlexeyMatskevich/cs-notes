...
Дополнительное преимущество: изоляция. Если один процесс убит [[linux/programming/memory-management#OOM killer: последняя линия защиты|OOM-killer]] — остальные продолжают работать.
