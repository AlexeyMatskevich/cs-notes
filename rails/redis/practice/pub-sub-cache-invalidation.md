...
Это типичная задача [когерентности локального vs внешнего кэша](../../../system-design/caching.md#когерентность-локальный-vs-внешний-кэш): данные уже обновились в основном хранилище, теперь нужно быстро донести факт изменения до всех локальных копий.
...
По модели обмена это именно [Pub/Sub](../../../system-design/message-queues.md#point-to-point-и-pubsub), а не очередь: одно событие должно дойти до всех живых процессов сразу, без `acknowledgment` и без хранения истории.
