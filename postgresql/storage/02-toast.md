...
[VACUUM](../maintenance/00-vacuum.md) чистит dead tuples на страницах. Но есть ещё одно ограничение страничной организации: одна версия строки (heap tuple) должна поместиться в одну страницу (~8 KB). Как хранить TEXT на мегабайты?
