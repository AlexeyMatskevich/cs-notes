...
**Предпосылки:** [страницы и кортежи](01-pages-and-tuples.md), [VACUUM](../maintenance/00-vacuum.md).
...
TOAST решает проблему хранения больших значений в рамках страничной организации. Полная картина физического хранения — от кластера до форков — описана в [справочнике по физической структуре](03-physical-layout.md).
