...
Когда нужен свободный буфер, PostgreSQL выбирает жертву для вытеснения. Используется **[clock-sweep](../../algorithms-and-data-structures/linear/07-clock-sweep.md)** — более дешёвая в синхронизации аппроксимация **[LRU](../../algorithms-and-data-structures/linear/06-lru-cache.md)**.
...
Буферный кеш оптимизирует доступ к страницам. Позже увидим, что UPDATE создаёт новые версии строк — буферный кеш хранит и старые, и новые, пока [VACUUM](../maintenance/00-vacuum.md) не освободит место.
