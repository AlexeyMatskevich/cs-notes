...
**Хеш‑структуры (`Hash Join`, `HashAggregate`).** Hash join строит хеш‑таблицу на одной стороне соединения. HashAggregate строит хеш‑таблицу групп. Если групп много (высокая кардинальность GROUP BY) или строки широкие, объём быстро растёт.
