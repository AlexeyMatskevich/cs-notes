...
**Предпосылки:** [MVCC](00-mvcc.md), [аномалии транзакций](01-anomalies.md).

PostgreSQL использует MVCC-структуры (xmin/xmax, CLOG, snapshot) для реализации уровней изоляции. Разница между уровнями — в том, когда берётся snapshot и что PostgreSQL делает при конфликте записи.
