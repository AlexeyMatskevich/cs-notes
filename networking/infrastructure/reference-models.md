...
**L7 load balancer** понимает HTTP и принимает решения на основе URL, заголовков, cookies. Подробнее о балансировке: [Load Balancing](../../system-design/load-balancing.md).
