...
**Предпосылки:** [IP и маршрутизация](../foundations/01-ip-and-routing.md) (пакет, инкапсуляция), [TLS](../application/02-tls.md) (шифрование, аутентификация), [Firewalls](02-firewalls.md) (зоны, внутренняя сеть).
...
Для корпоративных VPN WireGuard часто используется через обёртки (Tailscale, Netmaker), которые добавляют управление ключами, аутентификацию через SSO и discovery.
