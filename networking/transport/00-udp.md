...
**Предпосылки:** [IP и маршрутизация](../foundations/01-ip-and-routing.md) (IP-адрес, пакет, инкапсуляция).

<- [IPv6](../foundations/04-ipv6.md) | [TCP](01-tcp.md) ->
...
Когда надёжность всё-таки нужна — передача файлов, HTTP-запросы, работа с базами данных — используется [TCP](01-tcp.md).
