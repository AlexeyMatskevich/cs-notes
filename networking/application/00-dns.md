...
**Предпосылки:** [IP и маршрутизация](../foundations/01-ip-and-routing.md) (IP-адрес), [UDP](../transport/00-udp.md) (порт, датаграмма).

<- [TCP Tuning](../transport/02-tcp-tuning.md) | [HTTP](01-http.md) ->
...
DNS — первый шаг в цепочке от URL до страницы. После получения IP-адреса браузер устанавливает TCP-соединение и отправляет [HTTP-запрос](01-http.md).
