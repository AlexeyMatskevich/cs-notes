...
Для однократных запросов, CRUD API, загрузки файлов HTTP остаётся правильным выбором. WebSocket добавляет сложность: управление соединениями, reconnect, масштабирование ([sticky sessions](../../system-design/load-balancing.md) — привязка клиента к конкретному серверу — или синхронизация через общий брокер сообщений).
