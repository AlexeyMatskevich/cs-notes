...
**Предпосылки:** [IP и маршрутизация](01-ip-and-routing.md) (IP-адрес, маска подсети, шлюз по умолчанию), [Ethernet и коммутация](00-ethernet-and-switching.md) (MAC-адрес, широковещание).

<- [IP и маршрутизация](01-ip-and-routing.md) | [NAT](03-nat.md) ->
...
Через [широковещание](00-ethernet-and-switching.md#broadcast). Процесс получил название **DORA** — по первым буквам четырёх сообщений:
...
DHCP решает проблему конфигурации для IPv4. В [IPv6](04-ipv6.md) есть встроенный механизм автоконфигурации (SLAAC), но DHCPv6 тоже используется: иногда только для дополнительных параметров, а иногда и для централизованной выдачи адресов, если так устроена политика сети.
