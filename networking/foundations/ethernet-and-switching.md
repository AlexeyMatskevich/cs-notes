...
[IP и маршрутизация](ip-and-routing.md) ->
...
**Байт** — группа из 8 битов. Один байт хранит 2⁸ = 256 различных значений (от 0 до 255). Подробнее о двоичной системе, причинах выбора 8 бит и шестнадцатеричной записи — [основы представления данных](../../foundations/binary-and-bytes.md).
