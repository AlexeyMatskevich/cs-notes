...
<- [IP и маршрутизация](ip-and-routing.md) | [NAT](nat.md) ->
...
Через [[networking/foundations/ethernet-and-switching#broadcast|широковещание]]. Процесс получил название **DORA** — по первым буквам четырёх сообщений:
...
DHCP решает проблему конфигурации для IPv4. В [IPv6](ipv6.md) есть встроенный механизм автоконфигурации (SLAAC), но DHCPv6 тоже используется: иногда только для дополнительных параметров, а иногда и для централизованной выдачи адресов, если так устроена политика сети.
