...
**Предпосылки:** [IP и маршрутизация](01-ip-and-routing.md) (IP-адрес, маска, роутер, шлюз по умолчанию).

<- [DHCP](02-dhcp.md) | [IPv6](04-ipv6.md) ->
...
CGNAT и исчерпание IPv4-адресов — главная мотивация для перехода на [IPv6](04-ipv6.md), где огромного адресного пространства хватает без NAT как механизма экономии публичных адресов.
