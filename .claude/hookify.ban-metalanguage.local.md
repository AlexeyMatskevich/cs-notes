...
Метатермин из styleguide.md обнаружен в тексте заметки. Эти слова описывают процесс написания, а не предмет. Перефразируй предметным языком — текст должен говорить о теме, а не о том, как она объясняется. См. styleguide.md §0.1.
